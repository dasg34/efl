...
_efl_ui_focus_manager_base_redirect_events_del(Efl_Ui_Focus_Manager_Base *manager, Eo *obj)
{
   ...
   efl_event_callback_forwarder_del(manager, EFL_UI_FOCUS_MANAGER_BASE_EVENT_FOCUSED , obj);
...
_efl_ui_focus_manager_base_redirect_events_add(Efl_Ui_Focus_Manager_Base *manager, Eo *obj)
{
   ...
   efl_event_callback_forwarder_add(manager, EFL_UI_FOCUS_MANAGER_BASE_EVENT_FOCUSED , obj);
