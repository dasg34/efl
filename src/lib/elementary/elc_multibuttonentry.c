...
{
   efl_event_callback_del(ev->info, EFL_UI_FOCUS_MANAGER_BASE_EVENT_FOCUS_CHANGED, _legacy_focused, ev->object);
   efl_event_callback_add(efl_ui_focusable_focus_manager_get(ev->object), EFL_UI_FOCUS_MANAGER_BASE_EVENT_FOCUS_CHANGED, _legacy_focused, ev->object);
}
