...
_entry_value_apply(Evas_Object *obj)
{
   ...
   efl_event_callback_del(sd->ent, EFL_UI_FOCUSABLE_EVENT_FOCUS_CHANGED,
...
_toggle_entry(Evas_Object *obj)
{
   ...
   if (sd->entry_visible) _entry_value_apply(obj);
   else
     {
        ...
        efl_event_callback_add(sd->ent, EFL_UI_FOCUSABLE_EVENT_FOCUS_CHANGED,
                               _entry_focus_changed_cb, obj);
        sd->entry_visible = EINA_TRUE;
...
EOLIAN static Eina_Bool
_efl_ui_spin_button_efl_ui_focusable_on_focus_update(Eo *obj, Efl_Ui_Spin_Button_Data *sd)
{
...
_efl_ui_spin_button_efl_object_constructor(Eo *obj, Efl_Ui_Spin_Button_Data *sd)
{
   ...
   sd->text_button = efl_add(EFL_UI_BUTTON_CLASS, obj,
                             ...
                             efl_event_callback_add(efl_added, EFL_UI_FOCUSABLE_EVENT_FOCUS_CHANGED,
