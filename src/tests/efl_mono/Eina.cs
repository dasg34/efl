...
public static class BaseData
{
    ...
    public static Dummy.INumberwrapper NW(int n)
    {
    ...
    public static Dummy.INumberwrapper[] BaseSeqObj()
    {
        ...
        b.SetNumber(0x2A);
        c.SetNumber(0x42);
        return new Dummy.INumberwrapper[]{a,b,c};
    }
    ...
    public static void NumberwrapperSequenceAssertEqual(
        Dummy.INumberwrapper[] a
        , Dummy.INumberwrapper[] b
...
class NativeInheritImpl : Dummy.Test_ObjectInherit
{
...
class TestEinaArray
{
    ...
    {
        var a = new Eina.Array<Dummy.INumberwrapper>();
        Test.Assert(a.Handle != IntPtr.Zero);
    ...
    public static void eina_array_as_ienumerable_obj()
    {
        ...
        var arr = new Eina.Array<Dummy.INumberwrapper>();
    ...
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        Eina.Array<Dummy.INumberwrapper> arr;
...
class TestEinaInarray
{
    ...
    public static void push_obj()
    {
        var a = new Eina.Inarray<Dummy.INumberwrapper>();
        Test.Assert(a.Handle != IntPtr.Zero);
        var o = new Dummy.Numberwrapper();
        o.SetNumber(88);
    ...
    public static void eina_inarray_as_ienumerable_obj()
    {
        ...
        var arr = new Eina.Inarray<Dummy.INumberwrapper>();
        Test.Assert(arr.Handle != IntPtr.Zero);
    ...
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        Eina.Inarray<Dummy.INumberwrapper> arr;
...
class TestEinaList
{
    ...
    public static void data_set_obj()
    {
        var lst = new Eina.List<Dummy.INumberwrapper>();
    ...
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        Eina.List<Dummy.INumberwrapper> lst;
    ...
    public static void test_eina_list_obj_return_in_same_id()
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        var cmp = BaseSeqObj();
        var a = new Eina.List<Dummy.INumberwrapper>();
        a.AppendArray(cmp);
...
class TestEinaInlist
{
    ...
    public static void data_set_obj()
    {
        var lst = new Eina.Inlist<Dummy.INumberwrapper>();
    ...
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        Eina.Inlist<Dummy.INumberwrapper> lst;
    ...
    public static void test_eina_inlist_obj_return_in_same_id()
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        var cmp = BaseSeqObj();
        var a = new Eina.Inlist<Dummy.INumberwrapper>();
        a.AppendArray(cmp);
...
class TestEinaHash
{
    ...
    public static void data_set_obj()
    {
        var hsh = new Eina.Hash<Dummy.INumberwrapper, Dummy.INumberwrapper>();
        Test.Assert(hsh.Count == 0);
    ...
    {
        var hsh = new Eina.Hash<Dummy.INumberwrapper, Dummy.INumberwrapper>();
        var dct = new Dictionary<int, Dummy.INumberwrapper>();
        ...
        foreach (KeyValuePair<Dummy.INumberwrapper, Dummy.INumberwrapper> kvp in hsh)
        {
    ...
    public static void test_eina_hash_obj_in()
    {
        ...
        var nwv1 = NW(222);
        hsh[nwk1] = nwv1;
        Dummy.INumberwrapper nwk2;
        Dummy.INumberwrapper nwv2;
    ...
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        Eina.Hash<Dummy.INumberwrapper, Dummy.INumberwrapper> hsh;
        Dummy.INumberwrapper nwk1;
        Dummy.INumberwrapper nwv1;
        Test.Assert(t.EinaHashObjOut(out hsh, out nwk1, out nwv1));
        Test.Assert(!hsh.Own);
        Test.Assert(hsh[nwk1].raw_handle == nwv1.raw_handle);
        Test.Assert(hsh[nwk1].GetNumber() == nwv1.GetNumber());
        Test.Assert(hsh[nwk1].GetNumber() == 222);
        Dummy.INumberwrapper nwk2 = NW(44);
        Dummy.INumberwrapper nwv2 = NW(444);
        hsh[nwk2] = nwv2;
        hsh.Dispose();
        Test.Assert(hsh.Handle == IntPtr.Zero);
...
class TestEinaIterator
{
    ...
    public static void eina_array_obj_empty_iterator()
    {
        ...
        var itr = arr.GetIterator();
        int idx = 0;
        foreach (Dummy.INumberwrapper e in itr)
        {
            ++idx;
        }
        Test.AssertEquals(idx, 0);
    ...
    {
        var hsh = new Eina.Hash<Dummy.INumberwrapper, Dummy.INumberwrapper>();
        var dct = new Eina.Hash<int, Dummy.INumberwrapper>();
        var a = NW(22);
        var b = NW(44);
        var c = NW(88);
        var aa = NW(222);
    ...
    {
        Dummy.ITest_Object t = new Dummy.Test_Object();
        Eina.Iterator<Dummy.INumberwrapper> itr;
