...
class TestStrings
{
    ...
    private class StringReturner : Dummy.Test_ObjectInherit
    {
    ...
    {
        Dummy.ITest_Object obj = new StringReturner();
...
class TestStringshare
{
    ...
    private class StringshareReturner : Dummy.Test_ObjectInherit
    {
        public String received_in;
        public String received_in_own;
    ...
    {
        Dummy.ITest_Object obj = new StringshareReturner();
